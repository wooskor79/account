...
<body>
    ...
    <script src="accounts.js?v=<?php echo time(); ?>"></script>
    <script src="accounts_1.js?v=<?php echo time(); ?>"></script>
    <script src="quiz_core.js?v=<?php echo time(); ?>"></script>
    <script src="quiz_journal.js?v=<?php echo time(); ?>"></script>
    <script src="quiz_theory.js?v=<?php echo time(); ?>"></script>
    <script src="quiz_calc.js?v=<?php echo time(); ?>"></script>
